...
<div class="main">
		<div class="blog">
			<div class="blog_list">
				...
				<div class="blog_para">
					<p><a href="details.html"><img src="mobile/images/blog1.jpg" alt=""></a></p>
			...
			<div class="blog_list">
				...
				<div class="blog_para">
					<p><a href="details.html"><img src="mobile/images/blog2.jpg" alt=""></a></p>
					<p class="para">"Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua."</p>
					<div class="read_more">
						 <a class="btn" href="details.html">read more</a>
					</div>
			...
			<div class="blog_list">
				...
				<div class="blog_para">
					<p><a href="details.html"><img src="mobile/images/blog3.jpg" alt=""></a></p>
					<p class="para">"Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua."</p>
					<div class="read_more">
						 <a class="btn" href="details.html">read more</a>
					</div>
