...
<link rel='stylesheet' id='camera-css'  href='mobile/css/camera.css' type='text/css' media='all'>
<style>
body {
	margin: 0;
	padding: 0;
...
<script type='text/javascript' src='mobile/js/camera.min.js'></script> 
<script>
jQuery(function(){
...
<body>
	<div class="fluid_container">
			...
			<div class="header_sub">
					<div class="drp-dwn">
					 	<select onchange="window.location=this.options[this.selectedIndex].value">
							<option value="index.php?page=index">Home</option>
							<option value="index.php?page=about">About</option>
							<option value="index.php?page=locator">Locator</option>
							<option value="index.php?page=videos">Videos</option>
							<option value="index.php?page=articles">Articles</option>
							<option value="index.php?page=gym">Gym</option>
							<option value="index.php?page=contact">Contact us</option>
						</select>
					</div>
			</div>
		</div>
		...
		<div class="camera_wrap camera_emboss" id="main_page_wrap">
		  	<div data-thumb="images/slides/thumbs/main-slider-image-1.jpg" data-src="images/slides/main-slider-image-1.jpg">
				<div class="camera_caption fadeFromBottom">
					<h2>Take a step forward toward your health and look smart.</h2>
				</div>	    
			</div>
			<div data-thumb="images/slides/thumbs/main-slider-image-2.jpg" data-src="images/slides/main-slider-image-2.jpg">
				<div class="camera_caption fadeFromBottom">
					<h2>Health drinks and supplements.</h2>
				</div>    
			</div>
			<div data-thumb="images/slides/thumbs/main-slider-image-3.jpg" data-src="images/slides/main-slider-image-3.jpg">
				<div class="camera_caption fadeFromBottom">
		...
		<div class="main">
			...
			<div class="grids_of_3">
				<div class="grid1_of_3">
					<img src="mobile/images/icon1.png" alt=""/>
				...
				<div class="grid1_of_3">
					<img src="mobile/images/icon2.png" alt=""/>
				...
				<div class="grid1_of_3">
					<img src="mobile/images/icon3.png" alt=""/>
			...
			<div class="main content_top">
				...
				<div class="span_of_3">
					<div class="span1_of_3">
						<a href="details.html"><img src="mobile/images/health_drinks.jpg" alt=""/></a>
					...
					<div class="span1_of_3">
						<a href="details.html"><img src="mobile/images/nutrition.jpg" alt=""/></a>
						<div class="span1_of_3_text">
					...
					<div class="span1_of_3">
						<a href="details.html"><img src="mobile/images/exercise.jpg" alt=""/></a>
						<div class="span1_of_3_text">
				...
				<div class="span_of_3">
					<div class="span1_of_3">
						<a href="details.html"><img src="mobile/images/opening_rockstone_gym.jpg" alt=""/></a>
						<div class="span1_of_3_text">
					...
					<div class="span1_of_3">
						<a href="details.html"><img src="mobile/images/certified.jpg" alt=""/></a>
						<div class="span1_of_3_text">
					...
					<div class="span1_of_3">
						<a href="details.html"><img src="mobile/images/global_level.jpg" alt=""/></a>
						<div class="span1_of_3_text">
	...
	<div class="wrap">
			<ul id="flexiselDemo3">
			<!--	<li><img src="mobile/images/client1.jpg" /></li>
				<li><img src="mobile/images/client2.jpg" /></li>
				<div class="clear"></div>-->
			</ul>
	</div>
	<!-- Start Partners-->
